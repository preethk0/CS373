...
describe("Render Pages", () => {
  ...
  test("About", () => {
    ...
    expect(description).toContain(
      "Around the World is a website that provides information about"
    );
  });
...
describe("Render Components", () => {
  test("Bio Card", () => {
    const mockBioProps = {
      name: "Mock Developer",
      photo:
        "https://www.petplace.com/static/34b93d6fa8ec8aa3cdfd706fa8585f98/c85e8/shutterstock_1555613531.png",
  ...
  test("Model Card", () => {
    const mockModelProps = {
      name: "Mock Model",
      photo:
        "https://www.pngall.com/wp-content/uploads/4/German-Shepherd-Puppy-PNG-Picture.png",
  ...
  test("Tool Card", () => {
    const mockToolProps = {
      name: "Mock Tool",
      photo:
        "https://www.pngitem.com/pimgs/m/49-495842_cute-puppies-png-free-download-transparent-toy-poodle.png",
  ...
  test("Country Card", () => {
    ...
    const mockCountryProps = {
      country: {
        ...
        country_GDP_per_capita: 10824.0,
        country_calling_code: "1",
        country_capital: "Austin",
        country_cities: 1,
        country_currency: "USD",
        country_demographics_video_src:
          "https://www.youtube.com/embed/qtgyvfiu1cs",
        country_domain: ".ut",
        country_flag:
